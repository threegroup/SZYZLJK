package sm.wegis.szy.commands
{
	...
	public class ExportQueryDMCalcResultCommand extends CommandBase
	{
		override public function execute(event:CairngormEvent):void
		{
			...
			params.push(requestParam.dmId);
			params.push(requestParam.jisuanid);
			IDelegate(this.businessDelegate).executeWebServiceEx(WSMethod.GetDMExportUrlList, params);

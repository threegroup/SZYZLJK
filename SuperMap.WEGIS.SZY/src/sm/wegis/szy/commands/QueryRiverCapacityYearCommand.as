package sm.wegis.szy.commands
{
	...
	public class QueryRiverCapacityYearCommand extends CommandBase
	{
		...
		override public function result(data:Object):void
		{
			...
			var queryEvent:QueryEvent = new QueryEvent(QueryEvent.QUERY_RIVER_CAPACITY_YEAR_RESPONSE);
		...
		{
			CursorManager.removeBusyCursor();
			Alert.show("获取水资源承载力评价年份列表失败！", "提示", Alert.OK, null, null, 

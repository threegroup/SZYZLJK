package  sm.wegis.szy.components.drodown
{
	...
	[Event(name="selectChanged", type="sm.wegis.szy.events.DropDownPanelEvent")]
	...
	public class DropDownPanel extends List
	{
		//--------------------------------------------------------------------------
		//
		//  Class mixins
		 ...
		 *  @productversion Flex 4
		 */
		public function DropDownPanel()
		{
			super();
			
			dropDownController = new DropDownController();
			this.setStyle("skinClass", DropDownPanelSkin);
		}
		...
		{
			if (DropDownPanel.createAccessibilityImplementation != null)
				DropDownPanel.createAccessibilityImplementation(this);
		}
		/**
		 *  @private
		 */ 

package  sm.wegis.szy.components.chart
{
	import com.encoder.*;
	...
	public class FusionCharts extends UIComponent
	{
		...
		/**统计图是否可以改变大小，默认为true*/
		public var isResize:Boolean = true;
		...
		{
			errorData = "FusionCharts for Flex " +
				"needs External-Interface for cross " +
				"AVM communication between your Flex" +
				" project and the charts. It seems" +
				" that you\'ve not set Flash " +
				"security permissions for " +
				"this folder on your file" +
				" system. As such, External-Interface " +
				"is unable to initiate a connection." +
				" Please refer to \"FusionCharts for Flex\"" +
				" documentation on how to set proper security" +
				" permissions for your folder.";
			if (!isJSChecked)
			{
				dispatchEvent(new FCEvent(FCEvent.FCErrorEvent, errorData));
				isJSChecked = true;

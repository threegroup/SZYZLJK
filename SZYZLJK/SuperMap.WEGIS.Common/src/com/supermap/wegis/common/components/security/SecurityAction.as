package  com.supermap.wegis.common.components.security
{
	...
	public class SecurityAction
	{
		...
		private static var SECURITY_PATTERN : RegExp = /security\((\w*),?(\w*)\)?/;
		...
		public static function verifyControlBy(controlBy : String,comp : UIComponent,compId : String):void
		{

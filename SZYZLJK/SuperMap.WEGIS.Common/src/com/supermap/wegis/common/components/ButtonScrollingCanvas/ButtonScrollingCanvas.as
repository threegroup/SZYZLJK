package com.supermap.wegis.common.components.ButtonScrollingCanvas
{
	...
	{
		[Embed (source="com/supermap/wegis/common/icons/assets.swf", symbol="up_arrow")]
		...
		[Embed (source="com/supermap/wegis/common/icons/assets.swf", symbol="left_arrow")]
		...
		{
			var selector:CSSStyleDeclaration = StyleManager.getStyleManager(null).getStyleDeclaration("ButtonScrollingCanvas");
			...
			StyleManager.getStyleManager(null).setStyleDeclaration("ButtonScrollingCanvas", selector, false);

package  com.supermap.wegis.common.components.treeEx
{
	...
	public class LinkTree extends Tree
	{
		//数据源中状态字段
		...
		private var _hasCheckbox:Boolean = true;
		...
		public function set hasCheckbox(value:Boolean):void
		{
			_hasCheckbox = value;
		}
		...
		{
			var myFactory:ClassFactory=new ClassFactory(LinkTreeItemRenderer);
			myFactory.properties = {leafLevel:leafLevel};

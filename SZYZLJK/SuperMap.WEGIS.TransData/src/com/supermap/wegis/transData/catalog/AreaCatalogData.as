 ...
 * @author supermap
 */
public class AreaCatalogData extends TreeNode {
	...
	private var _nodesFlag:String;

	/**是否返回边境节点*/
	public function get nodesFlag():String
	{
		return _nodesFlag;
	}
	 ...
	 * @private
	 */
	public function set nodesFlag(value:String):void
	{
		_nodesFlag = value;
	}

 ...
 * @author supermap
 */
public class UserInitInfoData extends TreeNode {
    ...
    /**  用户有效时间 */
    private var _userEffectiveTime : String;

    /**  二级管理员 */
    private var _subManager : String;

    /**  用户描述 */
    private var _userDescinfo : String;
     ...
     * @return 用户有效时间
     */
    public function get userEffectiveTime():String {
        return this._userEffectiveTime;
    }

    /** 
     *  用户有效时间
     * 
     * @param userEffectiveTime 用户有效时间
     */
    public function set userEffectiveTime(userEffectiveTime : String):void {
        this._userEffectiveTime = userEffectiveTime
    }
     ...
     * @return 用户描述
     */
    public function get userDescinfo():String {
        return this._userDescinfo;
    }

    /** 
     *  用户描述
     * 
     * @param userDescinfo 用户描述
     */
    public function set userDescinfo(userDescinfo : String):void {
        this._userDescinfo = userDescinfo
    }

...
//hkh				else
		...
		override protected function createChildren():void {
			...
			FlexGlobals.topLevelApplication.systemManager.stage.addEventListener(KeyboardEvent.KEY_DOWN, keyboardHandler,false,0,true);
		...
		private function searchByServiceResult(evt:ResultEvent):void {
			var jsonRes:Object = JSONDecoder(evt.result.toString());

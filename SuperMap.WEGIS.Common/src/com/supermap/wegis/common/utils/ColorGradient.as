package com.supermap.wegis.common.utils
{
	...
	public class ColorGradient
	{
		 ...
		 * steps是指在多大的区域中渐变,  
		 */  
		public static function generateTransitionalColor( color1:uint, color2:uint, steps:int):ArrayCollection   
		{   
			if( steps < 3 )   
				return null;   
			...
			{   
				...
				colors.addItem( generateFromRGBComponent( tmpRGB ) );   
			}   
